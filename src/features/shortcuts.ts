...
class Shortcuts {
    mainWindow: any;            // BrowserWindow this shortcut set is bound to
    tabManager: any;            // Tabs instance for that window
    windowManager: any;         // WindowManager — for new-window shortcuts
    shortcuts: Map<string, () => void | boolean>;
