...
class FindDialog {
    manager;
    parentWindow; // BrowserWindow the dialog floats over
    parentWindowId; // that window's webContents id
    findWindow; // the frameless dialog BrowserWindow
    activeTab; // TabView the search runs in
    currentSearchTerm;
    isDestroyed;
