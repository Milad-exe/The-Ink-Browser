# Browser chrome renderer (`src/renderer/renderer.ts`)

> The main chrome UI — tab strip, omnibox, bookmark bar, pomodoro, downloads
> panel wiring. Compiled as a classic script (IIFE) into `app/renderer/`.
> Styling: Tailwind utilities + `Browser/styles.css`; see the
> [root README](../README.md#styling-tailwind--the-theme-system).
