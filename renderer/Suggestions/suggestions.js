...
(() => {
    (function () {
        ...
        const G = '%23888';
        const SVG_SEARCH = `data:image/svg+xml;utf8,<svg viewBox="0 0 24 24" fill="none" stroke="${G}" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>`;
        const SVG_GLOBE = `data:image/svg+xml;utf8,<svg viewBox="0 0 24 24" fill="none" stroke="${G}" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10"></circle><line x1="2" y1="12" x2="22" y2="12"></line><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path></svg>`;
        const SVG_BKMK = `data:image/svg+xml;utf8,<svg viewBox="0 0 24 24" fill="none" stroke="${G}" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"></path></svg>`;
        const SVG_HIST = `data:image/svg+xml;utf8,<svg viewBox="0 0 24 24" fill="none" stroke="${G}" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>`;
        const SVG_TAB = `data:image/svg+xml;utf8,<svg viewBox="0 0 24 24" fill="none" stroke="${G}" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><rect x="3" y="5" width="18" height="14" rx="2"></rect><path d="M3 9h18"></path></svg>`;
